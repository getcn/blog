...
?>
    ...
    //要创建的多级目录
    $path="../user_id/userphoto/time/user/".$row['username']."/photo";
...
//$vip=$row['user_developers'];
//$vips="vip";
//if(strstr($vip,$vips))
//echo "";
//else 
//echo "<script>alert('请先激活账号在上传');location='home.php';</script>";
	
?>
		  <!------------------->
<body>
<p><strong>点击提交后没有反应，请再点击一次</strong></p>
<p><strong>如需覆盖文最前面章显示图片，请在重新上传一个即可覆盖</strong></p>
<p><strong>图片上传，提交后，图片将不能再修改！</strong></p>
