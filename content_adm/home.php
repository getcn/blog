    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/">Rootcn</a> </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">功能 <span class="caret"></span></a>
             ...
             <li><a href="home.php?do=content">文章</a></li>
             <li><a href="home.php?do=bjqphp">在线测试</a></li>
             <li><a href="home.php?do=vocabulary_judge_mgc_gl">敏感词管理</a></li>
             <li><a class="disabled">===============</a></li>
             <li><a href="home.php?do=id_content" >管理用户</a></li>
              </ul>
            </li>
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
        <li class="active"><a href="home.php" target="_blank">首页</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li><a href="home.php?do=content">文章</a></li>
        <li><a href="home.php?do=bjqphp">在线测试</a></li>
        <li><a href="home.php?do=vocabulary_judge_mgc_gl">敏感词管理</a></li>
        <li><a target="_blank" href="wenjian_admin/wenjian_cn.php">文件管理</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li><a class="disabled">===============</a></li>
      ...
      <ul class="nav nav-sidebar">
        <li><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">用户</a>
          <ul class="dropdown-menu" aria-labelledby="userMenu">
            <li><a data-toggle="modal" data-target="#areDeveloping" title="该功能未上线">管理用户组</a></li>
            <li><a href="home.php?do=id_content" >管理用户</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="home.php?do=tx_avatar_content">头像上传</a></li>
            <li><a href="home.php?do=ewm_avatar_content">二维码上传</a></li>
          </ul>
        </li>
        <li><a class="dropdown-toggle" id="settingMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">设置</a>
          <ul class="dropdown-menu" aria-labelledby="settingMenu">
            <li><a href="home.php?do=home_settings&id=1">基本设置</a></li>
            <li><a href="home.php?do=homeindex_ku_ipkumysql">访问设置</a></li>
            <li><a data-toggle="modal" data-target="#areDeveloping">阅读设置</a></li>
			<li><a href="home.php?do=smtp_register_home&id=stmp">SMTP</a></li>
            <li role="separator" class="divider"></li>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="js/ccjs/images/weixin.jpg" alt="" style="cursor:pointer"/>正在架设中</div>
    </div>
  </div>
</div>
<!--提示模态框-->
...
<script src="js/ccjs/js/admin-scripts.js"></script>
	...
	@$do=$_GET['do'];
    if($do=='content'){
	include_once('content.php');//管理文章
	}else 
	if($do=="modify_content"){
	include_once('modify_content.php');//修改文章
	}else
	if($do=="added_content"){
	include_once('added_content.php');//新增文章
	}else
	if($do=='bjqphp'){
	include_once('phpbjq.php');//在线测试编辑器
	}else
	if($do=='vocabulary_judge_mgc_gl'){
	include_once('mgc_gl.php');//敏感词管理
	}else
	if($do=='id_content'){
	include_once('id_content_ad.php');//会员账号管理
	}else
	if($do=='tx_avatar_content'){
	include_once('tx_avatar_ad.php');//头像上传
	}else
	if($do=='id_userxg'){
	include_once('Modifymemberinformation.php');//会员账号修改
	}else
	if($do=='home_settings'){
	include_once('routinesettings.php');//常规设置
	}else
	if($do=='homeindex_ku_ipkumysql'){
	include_once('ip_ku_home.php');//地区管理
	}else
	if($do=='ewm_avatar_content'){
	include_once('ewm_avatar_ad.php');//联系方式》二维码
	}else
	if($do=='smtp_register_home'){
	include_once('register_smtp_home.php');//SMTP邮件
	}else{
	}
